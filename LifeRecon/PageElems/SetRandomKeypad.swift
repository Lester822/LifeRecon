        ...
        GeometryReader { geometry in
            ZStack(content: {
                RoundedRectangle(cornerRadius: 30.0)
                    .frame(width: 0.87*geometry.size.width, height: current_game.temporary_rotate_applied && (abs(current_game.temporary_rotate) == 180 || abs(current_game.temporary_rotate) == 0 || abs(current_game.temporary_rotate) == 360) ? 0.42*geometry.size.height: 0.45*geometry.size.height)
                    .foregroundColor(.white)
                    .opacity(0.97)
                VStack(content: {
                    Text("Custom Die")
                        .font(.largeTitle)
                        .padding(.bottom, current_game.temporary_rotate_applied && (abs(current_game.temporary_rotate) == 180 || abs(current_game.temporary_rotate) == 0 || abs(current_game.temporary_rotate) == 360) ? geometry.size.height * -0.005 : 0)
